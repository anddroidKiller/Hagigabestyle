...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            new Product { Id = 1, NameHe = "צלחות זהב 10 יח'", NameEn = "Gold Plates 10 pcs", DescriptionHe = "צלחות חד פעמיות בצבע זהב, חבילה של 10", DescriptionEn = "Gold disposable plates, pack of 10", Price = 29.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-gold-plates.jpg", CategoryId = 1, StockQuantityStore = 0, StockQuantityWarehouse = 100, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 2, NameHe = "כוסות קריסטל 20 יח'", NameEn = "Crystal Cups 20 pcs", DescriptionHe = "כוסות שקופות איכותיות, חבילה של 20", DescriptionEn = "Quality transparent cups, pack of 20", Price = 24.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-crystal-cups.jpg", CategoryId = 1, StockQuantityStore = 0, StockQuantityWarehouse = 150, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 3, NameHe = "מפיות פרימיום 50 יח'", NameEn = "Premium Napkins 50 pcs", DescriptionHe = "מפיות נייר איכותיות, חבילה של 50", DescriptionEn = "Quality paper napkins, pack of 50", Price = 19.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-napkins.jpg", CategoryId = 2, StockQuantityStore = 0, StockQuantityWarehouse = 200, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 4, NameHe = "מפת שולחן זהב", NameEn = "Gold Tablecloth", DescriptionHe = "מפת שולחן חד פעמית בצבע זהב", DescriptionEn = "Gold disposable tablecloth", Price = 14.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-gold-tablecloth.jpg", CategoryId = 2, StockQuantityStore = 0, StockQuantityWarehouse = 80, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 5, NameHe = "בלוני הליום 10 יח'", NameEn = "Helium Balloons 10 pcs", DescriptionHe = "בלונים צבעוניים עם הליום", DescriptionEn = "Colorful helium balloons", Price = 49.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-balloons.jpg", CategoryId = 3, StockQuantityStore = 0, StockQuantityWarehouse = 60, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 6, NameHe = "שרשרת דגלונים", NameEn = "Flag Garland", DescriptionHe = "שרשרת דגלונים צבעונית לקישוט", DescriptionEn = "Colorful flag garland for decoration", Price = 22.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-garland.jpg", CategoryId = 3, StockQuantityStore = 0, StockQuantityWarehouse = 90, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 7, NameHe = "סט סכום זהב 30 יח'", NameEn = "Gold Cutlery Set 30 pcs", DescriptionHe = "סכין, מזלג וכפית בצבע זהב", DescriptionEn = "Gold knife, fork and spoon set", Price = 34.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-cutlery-set.jpg", CategoryId = 4, StockQuantityStore = 0, StockQuantityWarehouse = 120, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 8, NameHe = "כובעי מסיבה 6 יח'", NameEn = "Party Hats 6 pcs", DescriptionHe = "כובעי מסיבה צבעוניים, חבילה של 6", DescriptionEn = "Colorful party hats, pack of 6", Price = 15.90m, CostPrice = 0m, ImageUrl = $"{img}/prod-party-hats.jpg", CategoryId = 5, StockQuantityStore = 0, StockQuantityWarehouse = 70, IsActive = true, CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        );
